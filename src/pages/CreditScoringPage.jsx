...
// Python credit scoring logic converted to JavaScript
...
// Hardcoded 50 users with realistic data
const hardcodedUsers = [
  ...
  { id: '45', name: 'Aarush Sengupta', loanAmount: 195000, tenure: 32, household_size: 4, number_of_earners: 2, lpg_refills_per_year: 14, car: false, phone: true, two_wheeler: true, fridge: true, house_type: 'pucca', landholding_in_hectares: 1.9, seasonal_income: 58000, number_of_loans_taken_before: 1, ever_defaulted_flag: 0, repay_default_prob: 0.15, status: 'approved' },
  { id: '46', name: 'Ishani Chatterjee', loanAmount: 82000, tenure: 17, household_size: 3, number_of_earners: 1, lpg_refills_per_year: 10, car: false, phone: true, two_wheeler: false, fridge: true, house_type: 'katcha', landholding_in_hectares: 0.75, seasonal_income: 26000, number_of_loans_taken_before: 0, ever_defaulted_flag: 0, repay_default_prob: 0.24, status: 'pending' },
  { id: '47', name: 'Advait Deshmukh', loanAmount: 370000, tenure: 55, household_size: 6, number_of_earners: 3, lpg_refills_per_year: 21, car: true, phone: true, two_wheeler: true, fridge: true, house_type: 'pucca', landholding_in_hectares: 3.6, seasonal_income: 92000, number_of_loans_taken_before: 3, ever_defaulted_flag: 0, repay_default_prob: 0.08, status: 'approved' },
  { id: '48', name: 'Tara Kulkarni', loanAmount: 61000, tenure: 10, household_size: 2, number_of_earners: 1, lpg_refills_per_year: 7, car: false, phone: true, two_wheeler: false, fridge: true, house_type: 'katcha', landholding_in_hectares: 0.35, seasonal_income: 18000, number_of_loans_taken_before: 1, ever_defaulted_flag: 0, repay_default_prob: 0.33, status: 'pending' },
  { id: '49', name: 'Om Tiwari', loanAmount: 245000, tenure: 40, household_size: 5, number_of_earners: 2, lpg_refills_per_year: 16, car: false, phone: true, two_wheeler: true, fridge: true, house_type: 'pucca', landholding_in_hectares: 2.3, seasonal_income: 70000, number_of_loans_taken_before: 2, ever_defaulted_flag: 0, repay_default_prob: 0.12, status: 'approved' },
  { id: '50', name: 'Siya Bansal', loanAmount: 50000, tenure: 9, household_size: 2, number_of_earners: 1, lpg_refills_per_year: 5, car: false, phone: true, two_wheeler: false, fridge: false, house_type: 'katcha', landholding_in_hectares: 0.22, seasonal_income: 14000, number_of_loans_taken_before: 2, ever_defaulted_flag: 1, repay_default_prob: 0.60, status: 'rejected' }
];

const CreditScoringPage = () => {
  const [applications, setApplications] = useState(() => {
    // Initialize with computed scores
